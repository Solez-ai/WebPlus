...
export async function testCommand(pattern: string, options: TestOptions): Promise<void> {
...
async function runTest(testFile: string, options: TestOptions): Promise<TestResult> {
...
function watchTests(pattern: string, options: TestOptions) {
