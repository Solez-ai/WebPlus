...
class WebPlusDebugger {
    ...
    private async cmdBreak(args: string[]) {
        if (args.length === 0) {
            // List breakpoints
...
// Main export
export async function debugCommand(source: string, options: any): Promise<void> {
