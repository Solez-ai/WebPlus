...
export async function buildCommand(source: string, options: any): Promise<void> {
...
async function createWasmLoader(outputDir: string, entryFile: string): Promise<void> {
